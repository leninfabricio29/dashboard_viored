        ...
        {emitter && (
          <div className="border-t pt-6 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
              ...
              <div>
                <span className="font-semibold text-gray-600">🪪 CI:</span>{" "}
                {emitter.ci}
              </div>
              <div>
          ...
          ${
            emitter.isActive
              ...
              <div className="md:col-span-2">
                ...
                {new Date(emitter.createdAt).toLocaleString()}
              </div>
            </div>
            ...
            <button
              ...
              className={`mt-6 w-full md:w-auto px-6 py-2 rounded-lg shadow transition duration-300 
    ${
      emitter.isActive
        ...
        : "bg-blue-700 hover:bg-blue-800 text-white"
            ...
            >
              {emitter.isActive ? "Ya validado" : "Validar Registro"}
            </button>
          </div>
        )}
      </div>
            ...
            <div className="flex items-center mb-6">
              <div className="bg-blue-100 p-2 rounded-full">
                <svg className="w-6 h-6 text-blue-700" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 10a3 3 0 100-6 3 3 0 000 6z" />
                  <path fillRule="evenodd" d="M.458 15.042A9.978 9.978 0 0110 0a9.978 9.978 0 019.542 15.042C17.17 16.89 13.84 18 10 18s-7.17-1.11-9.542-2.958zM10 16c3.313 0 6-1.343 6-3H4c0 1.657 2.687 3 6 3z" clipRule="evenodd" />
                </svg>
              </div>
